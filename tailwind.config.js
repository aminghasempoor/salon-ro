  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "swing-in-right-fwd":
          "swing-in-right-fwd 1s cubic-bezier(0.175, 0.885, 0.320, 1.275)   both",
        "swing-in-left-fwd":
          "swing-in-left-fwd 1s cubic-bezier(0.175, 0.885, 0.320, 1.275)   both",
        "swing-out-right-fwd":
          "swing-in-right-fwd 0.5s cubic-bezier(0.175, 0.885, 0.320, 1.275)   reverse both",
        "scale-in-tl":
          "scale-in-tl 0.25s cubic-bezier(0.250, 0.460, 0.450, 0.940)   both",
        "scale-in-tr":
        ...
        "scale-in-top":
          "scale-in-top 0.2s cubic-bezier(0.250, 0.460, 0.450, 0.940)   both",
        "scale-out-top":
          "scale-out-top 0.2s cubic-bezier(0.250, 0.460, 0.450, 0.940)  both",
        "height-change-100%": "height-change-100% 0.3s linear   alternate both",
        "height-change-0%": "height-change-0% 0.3s linear alternate both",
        "ripple-effect":
          "ripple-effect 0.25s cubic-bezier(1,-4.8, 1, 1)  both ",
        "scale-out-bottom":
          "scale-out-bottom 0.3s cubic-bezier(0.600, -0.280, 0.735, 0.045)   both",
        "scale-in-bottom":
          "scale-in-bottom 0.3s cubic-bezier(0.175, 0.885, 0.320, 1.275)   both",
